...
More information at https://github.com/senzing-garage/validate
...
More information can be found in the [pkg/github.com/senzing-garage/validate/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing-garage/validate/examplepackage"
		"github.com/senzing-garage/validate/anotherpackage"
	)
