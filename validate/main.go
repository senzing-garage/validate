...
var IdMessages = map[int]string{
	...
	3005: "Line %d: a RECORD_ID field is required",
	3006: "Line %d: a DATA_SOURCE field is required",
	3007: "Line %d: JSON-line not well formed",
	3008: "Line %d: did not validate for an unknown reason",
