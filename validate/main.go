...
var IdMessages = map[int]string{
	...
	2206: Prefix + "%d line(s) had no RECORD_ID field.",
	2207: Prefix + "%d line(s) had no DATA_SOURCE field.",
	2208: Prefix + "%d line(s) are not well formed JSON-lines.",
	2209: Prefix + "%d line(s) did not validate for an unknown reason.",
	2210: Prefix + "Validated %d lines, %d were bad.",
	4001: Prefix + "Fatal error parsing input-url.",
	4002: Prefix + "We don't handle %s input URLs.",
	4003: Prefix + "Fatal error retrieving input-url: %s",
	4004: Prefix + "Fatal error opening input file: %s",
	4005: Prefix + "Fatal error opening stdin.",
	4006: Prefix + "Fatal error stdin not piped.",
	4007: Prefix + "Fatal error opening gzipped file: %s",
	4008: Prefix + "Fatal error reading gzipped file: %s",
	4009: Prefix + "Fatal error retrieving gzipped input-url: %s",
	4010: Prefix + "Fatal error reading gzipped input-url: %s",
