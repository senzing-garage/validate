...
var IdMessages = map[int]string{
	...
	9001: Prefix + "Fatal error parsing input-url.",
	9002: Prefix + "We don't handle %s input URLs.",
	9003: Prefix + "Fatal error retrieving input-url: %s",
	...
	9009: Prefix + "Fatal error retrieving gzipped input-url: %s",
	9010: Prefix + "Fatal error reading gzipped input-url: %s",
